...
2. Check tasks: `bd ready` or `ai/TODO.md`
...
**Task tracking**: Beads (`bd`) preferred, `ai/TODO.md` fallback
...
**Version**: v0.1.2 | **Updated**: 2025-11-27 | **Follows**: [agent-contexts](https://github.com/nijaru/agent-contexts)
